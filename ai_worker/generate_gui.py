            ...
            try:
                ...
                if html_content and css_content:
                    if self.status_callback:
                        self.status_callback(f"✅ Generated with AI ({self.ai_provider})")
            except Exception as e:
                if self.status_callback:
                    self.status_callback(f"⚠️ AI generation failed: {e}, using template")
...
class SystemTrayApp:
    ...
    def show_status(self, icon=None, item=None):
        ...
        status_text = "🟢 Running" if self.worker.is_running() else "🔴 Stopped"
